...
public class ClassMetricVector {
    ...
    //CK Metrics
    @CsvBindByName(column = ClassMetricVectorConstants.COUPLING_BETWEEN_OBJECTS)
    private float couplingBetweenObjects;
    @CsvBindByName(column = ClassMetricVectorConstants.WEIGHTED_METHOD_CLASS)
    private int weightedMethodClass;
    @CsvBindByName(column = ClassMetricVectorConstants.TIGHT_CLASS_COHESION)
    private float tightClassCohesion;
    @CsvBindByName(column = ClassMetricVectorConstants.DEPTH_OF_INHERITANCE)
    private int depthOfInheritance;
    @CsvBindByName(column = ClassMetricVectorConstants.RESPONSE_FOR_A_CLASS)
    private int responseForAClass;
    @CsvBindByName(column = ClassMetricVectorConstants.LACK_OF_COHESION_OF_METHODS)
    ...
    public int getWeightedMethodClass() {
        return weightedMethodClass;
    }

    public void setWeightedMethodClass(int weightedMethodClass) {
        this.weightedMethodClass = weightedMethodClass;
    }
